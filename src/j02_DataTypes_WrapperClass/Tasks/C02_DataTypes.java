...
public class C02_DataTypes {
    public static void main(String[] args) {
        ...
        int birthDate=1999;
        int thisYear=2023;
        int hisAge=thisYear-birthDate;
        System.out.println(hisAge);
        System.out.println("His age is =" + (thisYear-birthDate));
        int myAge=29;
        double hisWeight=73.5;
        System.out.println("Count =" + (hisWeight-myAge) + " and " + myAge+hisWeight);
